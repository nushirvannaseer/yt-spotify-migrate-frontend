...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Movezic.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Movezic, accessible from{" "}
            <a
              href="https://movezic-app.vercel.app"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://movezic-app.vercel.app
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        The Company allows You to log in to use the Service through the
      ...
      <ul>
        <li>By email: nushirvannaseer@gmail.com</li>
      </ul>
    </>
  );
};
